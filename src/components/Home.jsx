      ...
      <div className="customer-feedback-container">
        ...
        <div className="customer-feedback-wrapper">
          ...
          <div className="customer-feedback-title-con">
            ...
            <p className="customer-feedback-title">
              Experience <br /> The Elegance With Origins
            </p>
          ...
          <div className="customer-feedback-con">
            ...
            <div className="customer-feedback-content">
              ...
              <img
                ...
                src="https://images.unsplash.com/photo-1599022484220-967921f2217c?q=80&w=371&auto=format&fit=crop&
ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              ...
              <div className="customer-feedback-text">
                ...
                <p className="customer-feedback-first-text">
                  Glowing Skin, All Day!
                </p>
                
                <p className="customer-feedback-sec-text">
                  I've been using Origins face serum for a few weeks now and my
                  skin has never looked better! M y skin feels so soft and I
                  have a natural glow that lasts all day. It's become an
                  essential part of my routine.
                </p>
                <br />
                <div className="customer-feedback-stars-con">
...
olid fa-star"
                ...
                <div className="customer-feedback-profile-con">
                  ...
                  <img
                    className="customer-feedback-profile-img"
                    src="https://plus.unsplash.com/premium_photo-1705018500148-383c65193a0f?q=80&w=870&aut
o=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt=""
                  />
                  
                  <div className="customer-feedback-profile-text">
                    <p className="customer-feedback-profile-name">Jessica</p>
                    <p className="customer-feedback-profile-role">
            ...
            <div className="customer-feedback-content">
              ...
              <img
                className="customer-feedback-img"
                src="https://images.unsplash.com/photo-1665763630810-e6251bdd392d?q=80&w=387&auto=format&fit=crop&
ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt=""
              />
              ...
              <div className="customer-feedback-text">
                ...
                <p className="customer-feedback-first-text">
                  Instant Skin Revival And Glow
                </p>
                
                <p className="customer-feedback-sec-text">
                  I've been using Origins products for years and they never
                  disappoint. The instant results are amazing. My skin feels so
                  soft and I have a natutal glow that lasts all day. Thank you
                  origins ❤️
                </p>
                <br />
                <div className="customer-feedback-stars-con">
...
o=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            <div className="customer-feedback-content">
              ...
              <img
                className="customer-feedback-img"
                src="https://images.unsplash.com/photo-1746676266118-18e4d6d402a2?q=80&w=387&auto=format&fit=crop&
ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt=""
              />
              ...
              <div className="customer-feedback-text">
                ...
                <p className="customer-feedback-sec-text">
                  Using Origins products has boosted my confidence in my skin's
                  appearance and health. I experi enced a significant
                  improvement in my skin's texture and tone!. I highly recommend
                  them
                </p>
                <br />
                <div className="customer-feedback-stars-con">
...
o=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            <div className="customer-feedback-content">
              ...
              <img
                className="customer-feedback-img"
                src="https://images.unsplash.com/photo-1715750968540-841103c78d47?q=80&w=327&auto=format&fit=crop&
ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt=""
              />
              ...
              <div className="customer-feedback-text">
                ...
                <p className="customer-feedback-sec-text">
                  Origins products have completely transformed my skin. I've
                  never felt more comfortable, confi dent, daring, outstanding,
                  bold and beautiful in my skin and appearance.
                </p>
                <br />
                <div className="customer-feedback-stars-con">
                  <i class="fa-solid fa-star"></i>
